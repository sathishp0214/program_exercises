...
class SavingAccount(Account):
    ...
    def createAccount(self, name, initialDeposite):
        ...
        print
        "Your account is successfully created, Your account number is {}".format(self.accountNumber)
    ...
    def authenticate(self, name, accountNumber):
        if accountNumber in self.savingAccounts.keys():
            ...
            print
            "all keys >>>>>>>>>>>>>" + str(self.savingAccounts.keys())
            print
            "name you enter>>>>>>>>>" + name
            print
            "name in database>>>>>>>" + self.savingAccounts[accountNumber][0]
            print
    ...
    def displaybalance(self, accountNumber):
        print
        "Available balance: {}".format(self.savingAccounts[accountNumber][1])
...
while True:
    print
    "Enter 1 to open an acc"
    print
    "Enter 2 to acess existing account"
    print
    "Enter 3 to exit"
